...
public class ModifPersonneView {
	...
	public ModifPersonneView(String user) {
		initialize(user);
	}
	...
	public void initialize(String user) {
		...
		wind = new JFrame();
		wind.setTitle("modifier personne");
		...
		JLabel lblNewLabel = new JLabel("Modifier " + user);
		...
		if(user.equals("client")) {
			...
			List<String> l = RespVenteDAO.getIDFrn();
			result = l.toArray(new String[l.size()]);
		...
		lblNewLabel_2.setBounds(98, 162, 77, 14);
		...
		lblNewLabel_4.setBounds(98, 248, 77, 14);
		contentPane.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("telephone");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblNewLabel_5.setForeground(Color.WHITE);
		lblNewLabel_5.setBounds(98, 286, 77, 23);
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (user.equals("client")) {
						...
						RespVenteDAO.suppClient(id);
						
					Personne c = new Client(
							id,
							textField_1.getText(),
							textField_2.getText(),
							textField_3.getText(),
						...
						RespAchatDAO.delFrn(id);
						
						Personne p = new Fournisseur(
								id,
								textField_1.getText(),
								textField_2.getText(),
								textField_3.getText(),
